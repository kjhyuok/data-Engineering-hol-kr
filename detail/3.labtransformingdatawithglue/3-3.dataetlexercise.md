...
#### 9. _S3 Target Location_에서 _Browse S3_를 선택하고 _`mod-xxx-dmslabs3bucket-xxx`_ 버킷을 찾아 tickets 폴더를 선택하고 Choose 를 눌러주세요.
...
Path의 끝부분에 `/`를 잊지 마세요. ![3-3-7](../../images/glue/dee-7.png)
